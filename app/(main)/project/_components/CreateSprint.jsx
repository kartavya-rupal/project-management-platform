                                        ...
                                        <Popover>
                                            ...
                                            >
                                                <DayPicker showOutsideDays 
                                                    ...
                                                    classNames={{
                                                        chevron: "fill-blue-700", // Changed from blue to black
                                                        range_start: "bg-blue-800 text-white", // Strong contrast for start date
                                                        range_end: "bg-blue-800 text-white",   // Same as start for consistency
                                                        range_middle: "bg-blue-300 text-white", // Dark grey for middle range
                                                        day_button: "border-none", // Kept as-is
